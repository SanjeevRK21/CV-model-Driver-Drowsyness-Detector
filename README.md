...
A real-time computer vision–based driver drowsiness detection system that monitors facial cues to identify fatigue and proactively alerts the driver and emergency contacts. The system combines eye closure, yawning, and head posture analysis, supports real-time alerts via Telegram, and provides post-drive analytics for deeper insights.
...
⏱️ Temporal smoothing using consecutive-frame logic
...
Drowsiness Detection
     ↓
┌───────────────┬────────────────┐
│ Local Alarm   │ Telegram Alert │
└───────────────┴────────────────┘
     ↓
CSV Logging → Post-drive Analysis
...
│
├── drowsysmooth_driver.py        # Main application
├── shape_predictor_68_face_landmarks.dat
├── alarm.wav
├── drowsiness_log.csv            # Auto-generated
├── user_EyeClosure_*.png         # Alert snapshots
├── ear_graph_*.png               # EAR graphs
├── post_combined_graph_*.png     # Session analysis
└── README.md
...
🚨 Do not hardcode tokens in production. Use environment variables for security.
